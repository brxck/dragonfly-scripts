...
(E\|echo) | "e"
(F\|foxtrot) | "f"
class \<text> | SCText(".[text] {")
media | Text("@media ") + Key("left/3:3")
media query | Text("@media () {") + Key("left/3:3")
close comment | Text(" */")
comment | Text("/*  */") + Key("left/3:3")
hex \<hex1>\<hex2>\<hex3> | Text("#[hex1][hex2][hex3]")
hex \<hex1>\<hex2>\<hex3>\<hex4>\<hex5>\<hex6> | Text("#[hex1][hex2][hex3][hex4][hex5][hex6]")
import | Text("@import ")
open comment | Text("/* ")
property \<prop> | SCText("[prop]: ")
property \<prop> \<text> | Text("[prop]: ") + SCText("[text]")
\<numeric> E M | Text("[numeric]em")
\<numeric> P T | Text("[numeric]pt")
\<numeric> P X | Text("[numeric]px")
